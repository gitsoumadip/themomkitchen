...
<script src="{{ asset('admin_assets/js/custom/submit.js') }}"></script>
<script src="{{ asset('admin_assets/js/custom/flash.js') }}"></script>
<script src="{{ asset('admin_assets/js/custom/auto-scroll.js') }}"></script>
...
<script
    ...
    async="" defer=""></script>
<script src="{{ asset('admin_assets/js/custom/google_location.js') }}"></script>
<script src="{{ asset('admin_assets/js/custom/geoPositionSimulator.js') }}"></script>
<script src="{{ asset('admin_assets/js/custom/geoPosition.js') }}"></script>
