            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-addtional-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-addtional" type="button" role="tab"
                                aria-controls="pills-addtional" aria-selected="false">Special <span><img
                                        src="{{ asset('assets/images/special.png') }}" class="img-fluid"
                                        alt=""></span></button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-addtional" role="tabpanel"
                            aria-labelledby="pills-addtional-tab">
                            <div class="menutab_con">
                                <div class="row">
                                    @foreach ($fetchTypeList as $key => $data)
                                        @if ($data->categorys->slug == 'special')
                                            <div class="col-md-6">
                                                <div class="menu_singlebox">
                                                    <div class="menus_left">
                                                        <img src="{{ asset('uploads/' . $data->img) }}" class="img-fluid"
