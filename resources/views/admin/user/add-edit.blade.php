    ...
    <div class="dashboard_mainsec">
        ...
        <div class="companydetails_head">
            ...
            <div class="backwardright">
                <a href="{{ route('admin.customer.list') }}"><i class="fa fa-backward"></i></a>
            </div>
        </div>
        <div class="company_profiles card-body">
            <form action="{{ route('admin.customer.add') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('admin.customer.list') }}"> <button type="button"
